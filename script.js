...
function createFallingHeart() {
  ...
  heart.src = "floatinghearts.png"; // ⚠️ replace with SAME image used in createHeart()

  heart.className = "teddy";
  heart.style.top = "-50px";
  heart.style.left = Math.random() * 100 + "vw";
  heart.style.animation = "fallDown 4s linear forwards";
