...
var floatingItem = "floatingpromise.png";
...
var promiseCards = document.getElementById("promiseCards");

var noMessages = [
  "You know I won’t break it.",
  "I mean this, Monika.🤗",
  "Now you can see the promises i made❤️"
];
var promiseList = [
  "I promise to choose you, even on the hard days.",
  "I promise to listen to you, not just hear you.",
  "I promise to grow with you, not away from you.",
  "I promise to protect your heart like my own.",
  "I promise — it’s us. Always."
];
...
var days = [
  ...
  promises: [
    ...
    "I promise to grow with you, not away from you 🌱",
    "I promise to never stop trying for us 🤞"
  ]
},
...
var index = 4; // 👈 FORCE PROMISE DAY FOR TESTING
...
var promiseContainer = document.getElementById("promiseCards");
promiseContainer.innerHTML = "";

if (todayData.promises) {
  todayData.promises.forEach((text, i) => {
...
yesBtn.onclick = function () {
  ...
  promiseCards.innerHTML = "";

  promiseList.forEach((text, i) => {
    setTimeout(() => {
      var card = document.createElement("div");
      card.className = "promise-card";
      card.innerText = text;
      promiseCards.appendChild(card);
    }, i * 1200);
  });
...
function createHeart() {
  ...
  teddy.src = teddy.src = floatingItem;
